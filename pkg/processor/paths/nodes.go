...
type executableNode interface {
	node
	Execute(namespace namespaces.Namespace) (valueNode, heimdallErrors.HeimdallError)
}
...
func newOpt(optStr string) (node, heimdallErrors.HeimdallError) {
	o := &optNode{}
	o.optStr = optStr
	...
	if !found {
		return nil, heimdallErrors.NewHeimdallInvalidArithmeticPathException("condition could not be resolved: "+optStr, nil)
	}
...
func (o *optNode) evalExpression(a valueNode, b valueNode) (v valueNode, err heimdallErrors.HeimdallError) {
	defer func() {
		r := recover()
		if r != nil {
			msg := fmt.Sprintf("unable to evaluate %v %s %v (%v)", a, o.optStr, b, r)
			v = nil
			err = heimdallErrors.NewHeimdallInvalidArithmeticPathException(msg, nil)
		}
	}()
	...
	if !aIsPrimitive || !bIsPrimitive || !isOperable(a, b) {
		...
		if (aObj == namespaces.ReferenceTypeInstance && bObj != nil) || (bObj == namespaces.ReferenceTypeInstance && aObj != nil) {
			...
			return nil, heimdallErrors.NewHeimdallInvalidArithmeticPathException(msg, nil)
		}
		...
		if evalErr != nil {
			...
			return nil, heimdallErrors.NewHeimdallInvalidArithmeticPathException(msg, evalErr)
		}
...
func (o *optNode) inExpression(a valueNode, b valueNode) (valueNode, heimdallErrors.HeimdallError) {
...
func (o *optNode) Execute(a valueNode, b valueNode) (valueNode, heimdallErrors.HeimdallError) {
	switch o.level {
...
func (l *listNode) Execute(namespace namespaces.Namespace) (valueNode, heimdallErrors.HeimdallError) {
...
func (c *comparisonNode) Execute(namespace namespaces.Namespace) (n valueNode, err heimdallErrors.HeimdallError) {
	left := c.left
	right := c.right
...
func (n *namespaceNode) Execute(namespace namespaces.Namespace) (valueNode, heimdallErrors.HeimdallError) {
	if namespace == nil {
		return nil, heimdallErrors.NewHeimdallInvalidArithmeticPathException("unable to Execute namespace operations on nil", nil)
	}
