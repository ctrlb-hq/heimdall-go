...
func (g *Generator) generateCallFallback(b *assembler.Builder) heimdallErrors.HeimdallError {
...
func (g *Generator) generateCheckStackUsage(b *assembler.Builder) heimdallErrors.HeimdallError {
	return b.AddInstructions(
		b.Label(startLabel),
		common.MovGToR12(b),
...
func (g *Generator) generateCallMorestack(b *assembler.Builder) heimdallErrors.HeimdallError {
	return b.AddInstructions(
...
func (g *Generator) generateJumpToStart(b *assembler.Builder) heimdallErrors.HeimdallError {
	return b.AddInstructions(
