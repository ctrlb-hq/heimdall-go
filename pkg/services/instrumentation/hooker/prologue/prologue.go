...
func NewGenerator(funcEntry uintptr, funcEnd uintptr, stackUsage int, fallbackAddr uintptr, getRegsUsed func() ([]assembler.Reg, heimdallErrors.HeimdallError)) (*Generator, heimdallErrors.HeimdallError) {
...
func (g *Generator) Generate() ([]byte, heimdallErrors.HeimdallError) {
...
func (g *Generator) generateShortPrologue() ([]byte, heimdallErrors.HeimdallError) {
...
func (g *Generator) generateLongPrologue() ([]byte, heimdallErrors.HeimdallError) {
