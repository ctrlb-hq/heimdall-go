...
func (g *Generator) generateFindFreeBackupSlot(b *assembler.Builder) heimdallErrors.HeimdallError {
...
func (g *Generator) generateBackup(b *assembler.Builder) heimdallErrors.HeimdallError {
...
func (g *Generator) generateBackupStackAddrs(b *assembler.Builder) heimdallErrors.HeimdallError {
	return b.AddInstructions(
		common.MovGToR12(b),
...
func (g *Generator) GenerateRegBackup(b *assembler.Builder) heimdallErrors.HeimdallError {
...
func (g *Generator) generateRestore(b *assembler.Builder) heimdallErrors.HeimdallError {
	for arg, offset := range smallRegToOffsetInBackup {
		err := b.AddInstructions(
...
func (g *Generator) generateReleaseBackupSlot(b *assembler.Builder) heimdallErrors.HeimdallError {
	return b.AddInstructions(
...
func (g *Generator) GenerateRegRestore(b *assembler.Builder) heimdallErrors.HeimdallError {
...
func (g *Generator) generateBackupSlot(b *assembler.Builder) heimdallErrors.HeimdallError {
	return b.AddInstructions(
...
func (g *Generator) generateRestoreSlot(b *assembler.Builder) heimdallErrors.HeimdallError {
	return b.AddInstructions(
		b.Inst(assembler.AMOVQ, x86asm.R12, r12Backup),
	)
}

func (g *Generator) generateRegUpdate(b *assembler.Builder) heimdallErrors.HeimdallError {
