...
func (c *breakpointFlowRunner) getHookWriter() (*safe_hook_installer.HookWriter, heimdallErrors.HeimdallError) {
...
func (c *breakpointFlowRunner) buildHook(hookAddr uintptr) ([]byte, heimdallErrors.HeimdallError) {
...
func NewFlowRunner(nativeAPI NativeHookerAPI, initInfo BreakpointFlowRunnerInitializationInfo, requiredBreakpoints []*probes.BreakpointInstance, installerFactory safe_hook_installer.SafeHookInstallerCreator) (*breakpointFlowRunner, error) {
