...
func (m *moduleDataPatcher) createPclnTable() heimdallErrors.HeimdallError {
...
func (m *moduleDataPatcher) alignPclntable() heimdallErrors.HeimdallError {
	...
	if uintptr(unsafe.Pointer(&m.newPclntable[m.funcOffset]))&4 != 0 {
		return heimdallErrors.NewFailedToAlignFunc(
